...
namespace Gungame.Commands
{
    ...
    public sealed class Gungame : ParentCommand
    {
        public Gungame() => LoadGeneratedCommands();
        ...
        public override string Command { get; } = "gungame";
        public override string[] Aliases { get; } = { "gun" };
